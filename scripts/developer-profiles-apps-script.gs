 ...
 *
 * Deployment:
 *   1. Open your developer pool spreadsheet and copy its ID from the URL
 ...
 *   6. Copy the generated /exec URL into the DEVELOPER_PROFILES_API_URL env
 *      var (see render.yaml / src/environments/environment.example.ts) —
